...
export const CriticalRiskCard: React.FC<CriticalRiskCardProps> = ({
  ...
  const timeAgo = getTimeAgo(event.occurred);
      ...
      <Tilt3D tiltMax={6} scale={1.01} perspective={1000}>
        ...
        >
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(160deg, rgba(255,255,255,0.03) 0%, transparent 40%, rgba(239,68,68,0.02) 100%)',
            }}
          />
          ...
          <div className="p-6">
            ...
            >
              <div className="rounded-lg bg-bg-primary/60 border border-error/10 p-3 backdrop-blur-sm"
                style={{ boxShadow: '0 4px 20px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.03)' }}
              >
                <p className="text-xs text-text-tertiary uppercase tracking-wide mb-1">Margin at Risk</p>
                <AnimatedNumber
              ...
              <div className="rounded-lg bg-bg-primary/60 border border-error/10 p-3 backdrop-blur-sm"
                style={{ boxShadow: '0 4px 20px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.03)' }}
              >
                <p className="text-xs text-text-tertiary uppercase tracking-wide mb-1">Revenue Exposed</p>
                <AnimatedNumber
              ...
              <div className="rounded-lg bg-bg-primary/60 border border-error/10 p-3 backdrop-blur-sm"
                style={{ boxShadow: '0 4px 20px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.03)' }}
              >
                <p className="text-xs text-text-tertiary uppercase tracking-wide mb-1">Time Horizon</p>
            ...
            >
              <div className="flex items-center gap-3 text-xs text-text-tertiary">
                <span className="flex items-center gap-1">
                  ...
                  {Math.round(scenario.financialImpact.confidence * 100)}% confidence
                </span>
                <span className="text-border">|</span>
                <span>{scenario.impactedProducts.length} products affected</span>
                <span className="text-border">|</span>
              ...
              <motion.button
                ...
                whileHover={{
                  scale: 1.05,
                  boxShadow: '0 8px 30px rgba(3,105,161,0.5), 0 0 20px rgba(3,105,161,0.2)',
                }}
                whileTap={{ scale: 0.95 }}
