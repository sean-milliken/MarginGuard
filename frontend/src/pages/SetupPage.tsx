      ...
      <div className="w-full max-w-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-text-secondary">
            MarginGuard models how supplier disruptions hit your cash and profit
        ...
        {!ownStep ? (
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <p className="text-sm text-text-secondary mb-4">
                Explore with Steel City Beverages — a pre-built beverage company
                with 3 products, 4 suppliers, and a realistic disruption already
                modeled.
              </p>
              <div className="space-y-1.5 mb-5">
                {[
                  "Everything pre-loaded — no setup needed",
                  "See real financial calculations instantly",
                  "Best way to understand the app first",
                ].map((f) => (
                  <div
                    key={f}
            ...
            >
              ...
              <p className="text-sm text-text-secondary mb-4">
                Add your company name as a display label. Products, suppliers,
                and financial inputs remain the synthetic Steel City Beverages
                dataset.
              </p>
              <div className="space-y-1.5 mb-5">
                {[
                  "Your company label in the dashboard and navigation",
                  "Same synthetic inputs and financial calculations",
                  "No real company data is imported",
                ].map((f) => (
                  <div
                    key={f}
                    className="flex items-center gap-2 text-xs text-text-secondary"
          ...
          <div className="rounded-2xl border border-primary-600/40 bg-bg-secondary p-8 max-w-md mx-auto">
            ...
            <p className="text-sm text-text-secondary mb-6">
              This is a display label for the demo. It does not replace the
              synthetic products, suppliers, or financial inputs.
            </p>
            <input
              type="text"
              ...
              onKeyDown={(e) =>
                e.key === "Enter" && companyName.trim() && pickOwn()
              }
        ...
        <p className="text-center text-xs text-text-tertiary mt-6">
          You can change the demo label at any time using Switch in the sidebar.
        </p>
      </div>
    </div>
  );
